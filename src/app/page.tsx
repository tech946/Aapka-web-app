...
export default function HomePage() {
  ...
  // Uncomment below to show maintenance page instead of homepage
  // return <MaintenancePage />;
}

/* 
// Previous maintenance page code (moved to reusable component)
// 'use client';
//
...
//   const callNumber = '+917042857575';
//   const whatsappNumber = '+971567809460';
