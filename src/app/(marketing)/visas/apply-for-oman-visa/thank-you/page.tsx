    ...
    <div className="oman-visa-thank-you-page">
      <div className="oman-visa-thank-you-container">
        ...
        <p className="oman-visa-thank-you-message">
          Thank you for submitting your Oman visa application. Processing time is approximately 24 hours after we receive complete documents and payment confirmation. Our team will contact you shortly.
        </p>
