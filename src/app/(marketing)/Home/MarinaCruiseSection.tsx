...
function getPackageDescription(pkg: MarinaPackage): string {
...
export default function MarinaCruiseSection() {
  ...
  if (loading) {
    return (
      <section className='tours-section marina-cruise-section'>
        <div className='container'>
          <div className='section-loading'>Loading marina cruises...</div>
        </div>
      </section>
    );
  }
