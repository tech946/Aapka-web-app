    ...
    async function fetchPackages() {
      try {
        const res = await fetch(
          '/api/packages?categorySlug=uae-tours&limit=20&status=active'
        );
    ...
    return (
      <section className='tours-section'>
        <div className='container'>
          <div className='section-loading'>Loading tours...</div>
        </div>
      </section>
    );
  }
      ...
      <div className='container'>
        <header className='section-header-pill'>
          ...
          <h2 className='section-heading-pill'>
            Curated day tours across Dubai & the UAE.
          </h2>
        </header>
        ...
        <div className='section-view-all'>
          <Link href='/category/uae-tours' className='section-explore-all-btn'>
            Explore All Package
            <ArrowRight size={20} />
          </Link>
        </div>
