-- Fixed properties table with correct data types
-- This fixes the foreign key constraint error

-- First, drop the existing properties table if it exists (be careful with this in production!)
-- DROP TABLE IF EXISTS properties CASCADE;

-- Create properties table with correct data types
CREATE TABLE IF NOT EXISTS properties (
  ...
  property_type_id INTEGER REFERENCES property_types(id) ON DELETE SET NULL, -- Fixed: INTEGER instead of UUID
  payment_plan TEXT,
  handover TEXT,
